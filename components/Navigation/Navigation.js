			...
			<nav className='bg-white fixed shadow max-w-screen-md z-10 mx-auto inset-x-0 top-0 flex justify-between items-center'>
				...
				>
					<button
						...
						className='font-bold mx-0 sm:mx-2 my-2 border-b-2 border-transparent hover:border-pink-600 hover:text-pink-700 transition-all duration-500 py-1 sm:p-0'
					>
						Profile
					</button>
					<button
