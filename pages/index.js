			...
			<Layout title='The Knotty Island || Handmade Macrame Decor'>
				...
				<div className='container'>
					<div className='flex flex-row flex-wrap justify-center'>
						<div className='m-10'>
							<h1 className='self-center text-8xl text-center font-title mb-2'>The Knotty Island</h1>
							<h2 className='self-center text-2xl text-center font-body'>Handmade Macrame Decor</h2>
						</div>
						<Vacation vacationMessage={vacationMessage} />
						<About />
						<Contact />
						<div className='flex flex-row flex-wrap font-body justify-center m-5'>
							<h1 className='w-full font-title text-center text-4xl sm:text-6xl mb-5'>Shop In Store</h1>

							<div className='mx-5'>
								<a href='https://artisanmadeco.com/' target='_blank' rel='noreferrer'>
		...
		return (
			<Layout title='The Knotty Island'>
				...
				<div className='container'>
					<div className='flex flex-row flex-wrap justify-center'>
						<div className='m-10'>
							<h1 className='self-center text-5xl sm:text-8xl text-center font-title mb-2'>The Knotty Island</h1>
							<h2 className='self-center text-xl sm:text-2xl text-center font-body'>Handmade Macrame Decor</h2>
						</div>
						<Categories />
						<div className='flex flex-row flex-wrap font-body justify-center m-5'>
							<h1 className='w-full font-title text-center text-4xl sm:text-6xl mb-5'>Shop In Store</h1>
